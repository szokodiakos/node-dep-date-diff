...
function *depDateDiff(_options) {
  ...
  for (const dep of deps) {
    ...
    const dateDiff = moment(latestVersionDate).diff(usedVersionDate, 'days');
    results.push({ packageName, type, usedVersion, usedVersionDate, latestVersion, latestVersionDate, dateDiff });
  }
